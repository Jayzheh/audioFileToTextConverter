...
export default function Home() {
  ...
  const handleFileSelect = async (file) => {
    ...
    try {
      ...
      const timeoutMs = 200000; // 3.3 minutes max
      ...
      if (data.success && data.text) {
        ...
        // Clear progress after 4 seconds to show conversion info
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-8 pt-8 relative">
          {/* Social Links - Top Right above Title */}
          <div className="flex justify-end mb-4">
            <div className="flex space-x-3">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="p-2 bg-white rounded-full shadow-lg hover:shadow-xl transition-all hover:bg-blue-50 group border border-gray-200"
                title="LinkedIn"
              >
